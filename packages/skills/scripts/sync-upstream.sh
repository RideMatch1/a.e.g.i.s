...
echo "  1. Run the pre-fork security-pass from"
echo "     aegis-precision/v018-redteam-skills-plan.md §5 plus the"
echo "     R0-review A-2 anti-analysis grep against any CHANGED or"
echo "     NEW files before accepting updates."
