...
//   [x] TP — insecure cookie in /api/test/ route path (N1-class, D-CA-001 regression-guard)
//   [x] FP — insecure cookie in *.test.ts basename (P1-class, isTestFile() canonical skip)
