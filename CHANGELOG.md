...
- **NEW `undici@8.2` runtime dependency** in `@aegis-scan/core`. ProxyAgent in 8.x defaults to `proxyTunnel = true` (CONNECT-tunneling for both HTTP and HTTPS targets), which matches mitmproxy / Burp / ZAP intercept proxies' default expectations.
